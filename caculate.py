...
def get_para():
    ...
    configuration_path = os.getcwd()
    try:
        para_path = configuration_path + '\\data' + '\\' + '定标参数.txt'
    ...
    # 写入参数历史文件
    try:
        with open(configuration_path + '\\data' + '\\' + '参数历史.txt', 'a') as f:
...
# folder_path = 'E:/BL03U_MassSpectrumTool/src/C6F11O2H/11.0eV'
...
# intens = get_signal('E:/BL03U_MassSpectrumTool/src/C6F11O2H/11.0eV/C23072501-0000.txt', 'head')
# print(intens)
...
# head_list = get_head_info(get_signal('E:/BL03U_MassSpectrumTool/src/C6F11O2H/11.0eV/C23072501-0000.txt', 'head'))
# print(head_list)
...
# # print(info)
# list_intensity = get_signal('E:/BL03U_MassSpectrumTool/src/C6F11O2H/12.0eV/C23072509-0000.txt', 'intensity')
...
def calculate(path):
    # path = 'E:/BL03U_MassSpectrumTool/src/C6F11O2H/12.0eV'  # 文件夹路径, 需要修改
...
# print(calculate('E:/BL03U_MassSpectrumTool/src/C6F11O2H/12.0eV'))
...
def main():
    ...
    # path = input('请输入文件夹路径：(E:/BL03U_MassSpectrumTool/src/C6F11O2H/12.0eV)')
    path = 'D:\OneDrive - USTC\桌面\港中文实验/20240422\C3H8-1\温度扫描/7.9eV'  # 文件夹路径, 需要修改
